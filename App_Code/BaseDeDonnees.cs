...
namespace WebApplicationCCPS
{
    public class BaseDeDonnees
    {
        ...
        {
            SqlDataReader dtValeursRetournees = null;
            SqlConnection sqlConn = null;
            SqlCommand SqlCmd;

            try
            {
                sqlConn = new System.Data.SqlClient.SqlConnection(ChaineDeConnexion);
                sqlConn.Open();
        ...
        public DataSet GetDataSet(String sqlParam)
        {
            ...
            try
            {
                ...
                sqlConn = new SqlConnection(ChaineDeConnexion);
                sqlConn.Open();
