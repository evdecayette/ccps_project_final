...
{
    public partial class CCPS_Dashboard : System.Web.UI.Page
    {
        ...
        protected void btnEtudiantsParClasse_Click(object sender, EventArgs e)
        {
            ...
            //#else
            String sUserName = "administrator", sDomain = "CCPAP-DEV", sPass = "ccpap123!!";
            //#endif
        ...
        // Fin Create CreateSpreadSheetProcess


        protected void btnInscrireNouveauxEtudiants_Click(object sender, EventArgs e)
        {
            Response.Redirect("Inscription_Etudiant.aspx");
        }

        protected void btnListeDesEtudiants_Click(object sender, EventArgs e)
        {
            Response.Redirect("listeDeTousLesEtudiants.aspx");
        }

        protected void btnModiferHoraire_Click(object sender, EventArgs e)
        {
            Response.Redirect("ChangerHoraireEtudiant.aspx");
        }


        protected void btnAjouterEtudiantsDansClasse_Click(object sender, EventArgs e)
        {
            Response.Redirect("AjouterEtudiantDansClasse.aspx");
        }

        protected void btnVoirEtudiantsParClasse_Click(object sender, EventArgs e)
        {
            Response.Redirect("VoirEtudiantParClasse.aspx");
        }

        protected void btnEnleverEtudiantsDansClasse_Click(object sender, EventArgs e)
        {
            Response.Redirect("Enlever-Etudiants.aspx");
        }

        protected void btnEtudiantsDejaGradues_Click(object sender, EventArgs e)
        {
            Response.Redirect("EtudiantGraduee.aspx");
        }

        protected void btnSetupPourAdmin_Click(object sender, EventArgs e)
        {
        ...
        protected void btnCreerSession_Click(object sender, EventArgs e)
        {
            Response.Redirect("CreerUneNouvellesession.aspx");
        }
    }
}